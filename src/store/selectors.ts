...
export const getProductInfoStatus = (state: RootState) => state.main.productInfo.status
...
export const getCatalogStatusMore = (state: RootState) => state.main.catalog.statusMore
